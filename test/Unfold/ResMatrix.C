void ResMatrix(const char* MOMCORRTYPE) {
...
//   DY
  ...
  gEnv->SetValue("ProofLite.Sandbox", "/home/asvyatko/DYStudy/CMSSW_5_3_3_patch2/src/DimuonAnalysis/DYPackage/test/Unfold/proofbox/");
  TProof* p = TProof::Open("workers=25");
  ...
  p->Process("DYM1020#/recoTree/DiMuonTree","EventSelector_Unf_Ult.C+");
  p->Process("DYM20#/recoTree/DiMuonTree","EventSelector_Unf_Ult.C+");
  p->Process("DYM200#/recoTree/DiMuonTree","EventSelector_Unf_Ult.C+");
  p->Process("DYM400#/recoTree/DiMuonTree","EventSelector_Unf_Ult.C+");
  p->Process("DYM500#/recoTree/DiMuonTree","EventSelector_Unf_Ult.C+");
  p->Process("DYM700#/recoTree/DiMuonTree","EventSelector_Unf_Ult.C+");
  p->Process("DYM800#/recoTree/DiMuonTree","EventSelector_Unf_Ult.C+");
  p->Process("DYM1000#/recoTree/DiMuonTree","EventSelector_Unf_Ult.C+");
